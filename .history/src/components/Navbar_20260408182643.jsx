      ...
      <div className="nav flex justify-between pl-10 pr-6 py-5 w-full fixed top-0 bg-white z-20">
        ...
        <ul className="hidden md:flex gap-6">
          ...
          <li className="flex gap-2 self-center ml-3">
            ...
            <Link
              to="/cart"
              className="hover:bg-gray-500 duration-200 rounded-full flex justify-center items-center active:scale-90"
            >
              <svg
          ...
          <li className="self-center active:scale-90 transition">
            <Link
              to="/login"

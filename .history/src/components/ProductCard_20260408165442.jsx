    ...
    <div className="bg-white rounded-2xl shadow p-4 flex flex-col hover:scale-105 duration-300 text-lg">
      ...
      <div className="mt-auto flex flex-col justify-between items-center">
        ...
        <button
          ...
          className={`text-lg mt-4 mb-2 bg-gray-900 ${added && "bg-gray-50 text-gray-900"} text-white ${location.pathname === "/search" ? "px-20 sm:px-11 xl:px-11 2xl:px-12" : "px-32"} py-2 rounded-full hover:bg-gray-500 transition duration-300`}
        >
          {added ? (

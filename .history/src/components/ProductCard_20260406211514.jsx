...
export default function ProductCard({ p, onAdd }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow p-4 flex flex-col hover:scale-x-105 hover:scale-y-110 duration-300 text-lg">
      <img
        src={p.image}
      ...
      <div className="mt-auto flex flex-col justify-between items-center">
        ...
        <button
          ...
          className="text-lg mt-4 bg-gray-900 text-white px-28 py-2 rounded-full hover:bg-gray-500 transition duration-300"
        >

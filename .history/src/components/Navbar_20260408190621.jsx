    ...
    <>
      ...
      <div className="nav flex justify-between pl-10 pr-6 py-5 w-full fixed top-0 bg-white z-20">
        ...
        <ul className="hidden md:flex gap-6">
          <li className="hover:scale-120 hover:text-gray-500 self-center duration-200 active:scale-95">
          ...
          <li className="hover:scale-120 hover:text-gray-500 self-center duration-200 active:scale-100">
            <Link to="/contact" className="text-lg">
              Contact
            </Link>
          </li>

          <li className="hover:scale-120 hover:text-gray-500 self-center duration-200 active:scale-110">
          ...
          <li className="flex gap-2 self-center ml-3">
            ...
            <Link
              to="/cart"
              className="hover:bg-gray-500 duration-200 rounded-full flex justify-center items-center active:scale-95"
            >
              <svg
          ...
          <li className="self-center active:scale-95 transition">
            <Link
              to="/login"

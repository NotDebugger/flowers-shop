    ...
    <div className="bg-white rounded-2xl shadow p-4 flex flex-col hover:scale-105 duration-300 text-lg">
      ...
      <div className="mt-auto flex flex-col justify-between items-center">
        ...
        <button
          ...
          className={`text-lg mt-4 mb-2 bg-gray-900 text-white ${added && "bg-gray-100! text-gray-500! hover:bg-gray-500! hover:text-white!"} ${location.pathname === "/search" ? "px-36 sm:px-16 md:px-10 lg:px-11" : "px-36 sm:px-16 md:px-10 lg:px-11 xl:px-20"} py-2 rounded-full hover:bg-gray-500 transition duration-500`}
        >
          {added ? (
            <div className="flex items-center gap-1">
              <svg
                className={`${added && "fill-gray-500 hover:fill-gray-50!"}`}

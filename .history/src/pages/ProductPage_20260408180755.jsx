      ...
      <div className="flex flex-col-reverse md:flex-row justify-center md:justify-between px-4 py-12 md:px-20 bg-gray-50 mt-10 md:py-32 gap-10">
        <div className="text-black w-full md:w-1/3">
          ...
          {added ? (
            <Link
              to="/cart"
              className={`${added && "bg-gray-200! text-gray-500! hover:first:fill-gray-50 hover:bg-gray-500! hover:text-white!"} text-lg flex justify-center items-center gap-1 bg-gray-900 text-white px-6 py-2 rounded-full w-full text-center hover:bg-gray-500 transition mb-4`}
            >
              <svg

        ...
        <div className="text-black w-full md:w-1/3">
          ...
          {added ? (
            ...
            <button
              ...
              className="text-lg bg-gray-900 flex justify-center items-center gap-1 text-white px-6 py-2 rounded-full w-full hover:bg-gray-500 transition mb-4 active:scale-3d"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="22px"

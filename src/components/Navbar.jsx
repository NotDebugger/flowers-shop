      ...
      <div className="nav flex justify-between pl-10 pr-6 py-5 w-full fixed top-0 bg-white z-20">
        ...
        >
          <ul className="flex flex-col items-center gap-4">
            <Link to="/" onClick={() => setOpen(false)} className="text-lg">Home</Link>
            <Link to="/shop" onClick={() => setOpen(false)} className="text-lg">Shop</Link>
            <Link to="/contact" onClick={() => setOpen(false)} className="text-lg">Contact</Link>
            <Link to="/about" onClick={() => setOpen(false)} className="text-lg">About</Link>
            <Link
              to="/cart"
              onClick={() => setOpen(false)}
